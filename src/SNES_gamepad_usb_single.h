// define this macro to opt-out mutiplayer interfaces
// this is optional, singleplayer will work anyway
...
// SNES and N64 gamepad (concrete) and other classes do,,, and remember always: KISS!